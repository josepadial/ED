	  ...
	  public:
		    ...
		    */
		    Guia_Tlf operator+(const Guia_Tlf & g){
			    ...
			    for(c_iter it = g.datos.begin(); it != g.datos.end(); it++){
			      iter itr = aux.datos.find(it->first);
			      if (itr == aux.datos.end())
			        aux.datos.insert(pair<string,string>(it->first,it->second));
			    }
			...
			Guia_Tlf& operator+=(const Guia_Tlf & g){
			    ...
			    for(c_iter it = g.datos.begin(); it != g.datos.end(); it++){
			      iter itr = datos.find(it->first);
			      if (itr == datos.end())
			        datos.insert(pair<string,string>(it->first,it->second));
			    }
		    ...
		    */
		    ...
		    bool operator == (const Guia_Tlf &otro){
